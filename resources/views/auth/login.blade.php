            ...
            <div class="flex min-h-screen w-full flex-col items-center justify-center gap-8 px-4 py-[46px]">
                ...
                <form method="POST" action="{{ route('login') }}"
                    ...
                    <button type="submit"
                        ...
                        In</button>
                    <p class="tracking-035 text-darkGrey text-center text-sm">Don’t have account? <a href="signup.html"
                            class="font-semibold tracking-[0.6px] text-[#4D73FF]">Sign Up</a></p>
                </form>
            </div>
        </section>
    </body>
