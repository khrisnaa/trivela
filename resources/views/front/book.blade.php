    ...
    <section id="content" class="mx-auto flex min-h-screen w-full max-w-[640px] flex-col gap-8 bg-[#F9F2EF] pb-[120px]">
        ...
        <form method="POST" action="{{ route('front.book.store', $packageTour->slug) }}" class="flex flex-col gap-8">
            ...
            <div class="flex flex-col gap-3 px-4">
                ...
                <div class="flex items-center gap-[10px] rounded-[37px] bg-white p-[16px_24px] transition-all duration-300">
                    ...
                    <div class="flex h-6 w-6 shrink-0">
                        <img src="{{ asset('assets/icons/calendar-blue.svg') }}" class="h-full w-full" alt="icon">
                    </div>
                </div>
            </div>
            <div class="flex flex-col gap-3 px-4">
                ...
                <div class="flex items-center gap-3 rounded-[26px] bg-white p-4">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <div class="flex items-center gap-1">
                            <div class="h-4 w-4">
                                <img src="{{ asset('assets/icons/location-map.svg') }}" class="h-4 w-4" alt="icon">
                            </div>
                            <span
