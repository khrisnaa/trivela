...
@section('content')
    <section id="content" class="mx-auto flex min-h-screen w-full max-w-[640px] flex-col gap-8 bg-[#F9F2EF] pb-[120px]">
        ...
        @if ($errors->any())
            ...
            @endforeach
        @endif
        <form method="POST" action="{{ route('front.book_payment_store', $packageBooking) }}" enctype="multipart/form-data"
                ...
                <div class="flex items-center gap-3 rounded-[26px] bg-white p-4">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <div class="flex items-center gap-1">
                            <div class="h-4 w-4">
                                <img src="{{ asset('assets/icons/calendar-grey.svg') }}" class="h-4 w-4" alt="icon">
                            </div>
                ...
                <div class="flex flex-col gap-4 rounded-[26px] bg-white p-[16px_24px]">
                    <div class="flex flex-col gap-1">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="tracking-035 text-sm leading-[22px]">{{ $packageBooking->bank->bank_name }}</span>
                        </div>
                    </div>
                    <div class="flex flex-col gap-1">
            ...
            <div class="flex flex-col gap-3 px-4">
                ...
                <div class="flex items-center gap-3">
                    <button type="button" id="upload-file"
                        ...
                        <p id="placeholder" class="text-nowrap text-darkGrey tracking-035 text-left text-sm leading-[22px]">
                            Upload
                            transfer proof</p>
                ...
                <div
                    ...
                    <img src="{{ asset('assets/icons/moneys.svg') }}" class="h-full object-contain" alt="rewards">
            ...
            <div
                ...
                <div class="flex flex-col justify-center gap-1">
                    ...
                    <p id="grandtotal" class="text-lg font-semibold leading-[26px] tracking-[0.6px] text-[#EED202]">Rp
