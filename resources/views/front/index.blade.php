    ...
    <body class="font-poppins text-black">
        <section id="content"
            ...
            <nav class="mt-8 flex w-full items-center justify-between px-4">
                <div class="flex items-center gap-3">
                    ...
                    @guest
                        <div
                            class="flex h-12 w-12 shrink-0 overflow-hidden rounded-full border-4 border-white shadow-[6px_8px_20px_0_#00000008]">
                            <img src="assets/photos/pfp.png" class="h-full w-full object-cover object-center"
                                alt="photo">
                        </div>
                        <div class="flex flex-col gap-1">
                            <p class="tracking-035 text-xs">Welcome!</p>
                                ...
                                <div class="flex justify-between gap-2">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <span
                                                class="text-darkGrey tracking-035 text-sm">{{ $tour->location }}</span>
                                        </div>
                                    </div>
            ...
            <div id="discover" class="px-4">
                <div
                    class="relative flex h-[130px] w-full flex-col items-center gap-[10px] overflow-hidden rounded-[22px]">
                    <img src="assets/backgrounds/Banner.png" class="h-full w-full object-cover object-center"
                        alt="background">
